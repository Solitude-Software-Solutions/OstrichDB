...
OST_EXECUTE_COMMAND :: proc(cmd: ^types.Command) -> int {
	...
	// 				OST_ENCRYPT_COLLECTION(cmd.l_token[0], .STANDARD_PUBLIC, &types.current_user)
	// 			} else {
	// 				fmt.printf(
	...
	// 				return -1
	// 			}
	// 			OST_DECRYPT_COLLECTION(cmd.l_token[0], .STANDARD_PUBLIC, &types.current_user)
	...
	// 			OST_DECRYPT_COLLECTION(oldName, .STANDARD_PUBLIC, &types.current_user)
	...
	// 			OST_ENCRYPT_COLLECTION(newName, .STANDARD_PUBLIC, &types.current_user)
	// 		} else {
	...
	// 			OST_DECRYPT_COLLECTION(collectionName, .STANDARD_PUBLIC, &types.current_user)
	// 			//--------------Permissions Security stuff Start----------------//
	// 			permissionCheckResult := security.OST_PERFORM_PERMISSIONS_CHECK_ON_COLLECTION(
	// 				WHERE,
	// 				collectionName,
	...
	// 			)
	// 		}
	// 		OST_ENCRYPT_COLLECTION(collectionName, .STANDARD_PUBLIC, &types.current_user)
	// 		break
	// 	case 3:
	// 		oldRName: string
	// 		newRName: string
	...
	// 		OST_DECRYPT_COLLECTION(colName, .STANDARD_PUBLIC, &types.current_user)
	...
	// 		OST_ENCRYPT_COLLECTION(colName, .STANDARD_PUBLIC, &types.current_user)
	// 		break
	// 	case 2:
	// 		colName := cmd.l_token[0]
	// 		flag := cmd.l_token[1]
	...
	// 	case 1:
	// 		colName := cmd.l_token[0]
	// 		if security.OST_ENCRYPT_COLLECTION(colName, .STANDARD_PUBLIC, &types.current_user) ==
	// 		   0 {
	// 			fmt.printfln(
	...
	// 			// security.OST_DECRYPT_COLLECTION(colName, .STANDARD_PUBLIC, &types.current_user)
	// 		} else {
	// 			fmt.printfln(
