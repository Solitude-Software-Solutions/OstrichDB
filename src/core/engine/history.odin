...
OST_APPEND_COMMAND_TO_HISTORY :: proc(input: string) {
	...
	AUTO_OST_UPDATE_METADATA_VALUE(const.OST_HISTORY_PATH, 2)
	AUTO_OST_UPDATE_METADATA_VALUE(const.OST_HISTORY_PATH, 3)
	AUTO_OST_UPDATE_METADATA_VALUE(const.OST_HISTORY_PATH, 5)
}
